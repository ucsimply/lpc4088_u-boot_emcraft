...
/*
 * Configuration settings for the uCSimply LPC4088 module.
 */
...
/*
 * This is an ARM Cortex-M3 class CPU core
 * but really it's a Cortex-M4 CPU
 * 
 */
...
/*
 * This is the NXP LPC4088 (LPC1788) device
 */
 ...
 * This runs the tools/lpc178x_fcg utility, which inserts
 * the checksum into the BIN file. 
 * We utilize the Flash Magic tool which uses a HEX file
 * and adds the checksum when programming the Flash.
 ...
 * Monitor prompt
 */
#define CONFIG_SYS_PROMPT		"UCS-LPC4088> "
...
/* Clock configuration 
 * (see cpu/arm_cortexm3/lpc178x/clock.c for details)
 */
...
#define CONFIG_LPC178X_ETH_DIV_SEL	10	/* HCLK/44 */
/*
